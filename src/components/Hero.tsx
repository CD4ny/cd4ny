...
function Hero() {
  const description =
    "Estudiante de ingeieria de software ," +
    "programador especializado en Backend," +
    " con experiencia en tecnologias frontend," +
    "interesado en diseño del sistema y grafico; "+
    "entusiasta de la IA, la algoritmia, las matemáticas. ";
  ...
  return (
    <section id="about" className="flex flex-col-reverse md:flex-row p-4 justify-center items-center min-h-screen pt-20 sm:pt-0">
      <div className=" max-w-sm">
        ...
        <br />
        <h1 className="text-blue_(munsell)-800 font-nunito">
          Tecnologias Web
        </h1>
        ...
        <p></p>
        <p className="inline text-xs font-light font-nunito text-blue_(munsell)-700">DevOps: </p>
        <p className="inline text-xs font-extralight font-montserrat text-orange_(web)-400">{"Pronto..."}</p>
      </div>
      <img
        src={profile}
